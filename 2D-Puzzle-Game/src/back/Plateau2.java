...
public class Plateau2 extends Plateau {
    ...
    protected CasePlateau[][] initialiserPlateau() {
        ...
        plateau[4][5] = new CasePlateau(CasePlateau.TypeCase.LAVE, 4, 3);
        plateau[4][6] = new CasePlateau(CasePlateau.TypeCase.POMME, 4, 3);
        plateau[4][7] = new CasePlateau(CasePlateau.TypeCase.LAVE, 4, 3);
        plateau[8][13] = new CasePlateau(CasePlateau.TypeCase.LAVE, 4, 3);
        ...
        plateau[6][3] = new CasePlateau(CasePlateau.TypeCase.PIQUE, 6, 4);
        plateau[6][4] = new CasePlateau(CasePlateau.TypeCase.POMME, 6, 4);
